...
import com.deng.rsdis.SeckillKeyPrefix;
...
public class SeckillService {
     ...
     * 执行秒杀操作，包含以下两步：
     * 1.从goods表中减库存
     * 2.将生成的订单写入seckill_order表中
     *
     * @param seckillUser 秒杀商品的用户
     * @param goodsVo  所秒杀的商品
     * @return  生成的订单信息
     */
    @Transactional
    public OrderInfo sekill(SeckillUser seckillUser, GoodsVo goodsVo){
